...
let tasks = [{ desc: "Buy fruits", completed: false, index: 0}, { desc: "Reply the pending emails", completed: false, index: 1}, { desc: "Do household work", completed: false, index: 2},]
